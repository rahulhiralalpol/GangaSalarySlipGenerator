...
export class GeneralService {
  ...
  GeneratePDF(inputExcel) {
    ...
    /*doc.addFileToVFS("assets/fonts/Roboto/Roboto-Black.ttf", "RobotoBlack");
    doc.addFileToVFS("assets/fonts/Roboto/Roboto-Bold.ttf", "RobotoBold");
    doc.addFileToVFS("assets/fonts/Roboto/Roboto-Medium.ttf", "RobotoMedium");
    doc.addFileToVFS("assets/fonts/Roboto/Roboto-Regular.ttf", "RobotoRegular");
    doc.addFileToVFS("assets/fonts/Roboto/Roboto-Light.ttf", "RobotoLight");
    doc.addFileToVFS("assets/fonts/Roboto/Roboto-Thin.ttf", "RobotoThin");

    doc.addFont(
      "assets/fonts/Roboto/Roboto-Black-normal.js",
      "RobotoBlack",
      "normal"
    );
    doc.addFont("assets/fonts/Roboto/Roboto-Bold.ttf", "RobotoBold", "normal");
    doc.addFont(
    ...
    doc.addFont("assets/fonts/Roboto/Roboto-Thin.ttf", "RobotoThin", "normal");*/
    ...
    for (Employee of Employees) {
      ...
      doc.line(24, 16.8 + ypos, 41, 16.8 + ypos);
      doc.line(554.2, 16.8 + ypos, 571.2, 16.8 + ypos);

      doc.setLineWidth(0.7);
      doc.line(49.11, 37.751 + ypos, 49.11, 68.932 + ypos);
      doc.line(49.11, 78.001 + ypos, 49.11, 89.34 + ypos);
      doc.line(49.11, 96.778 + ypos, 49.11, 122.274 + ypos);
      doc.line(49.11, 131.13 + ypos, 49.11, 250.07 + ypos);
      doc.line(385.795, 37.751 + ypos, 385.795, 68.932 + ypos);
      doc.line(385.795, 78.001 + ypos, 385.795, 89.34 + ypos);
      doc.line(385.795, 96.778 + ypos, 385.795, 122.274 + ypos);
      doc.line(385.795, 131.13 + ypos, 385.795, 250.07 + ypos);
      doc.line(262.063, 225.238 + ypos, 262.063, 250.07 + ypos);
      doc.line(348.094, 225.238 + ypos, 348.094, 250.07 + ypos);

      doc
        .setFont("Roboto-Black-normal.js", "normal")
        .setFontSize(12)
        .text("SALARY SLIP", 55.155, 47.232 + ypos);
      doc
        .setFont("RobotoLight", "normal")
        .setFontSize(12)
      ...
      doc
        ...
        .text(Employee.PF_NUMBER, 139.5, 97.169 + ypos, {
          width: 241,
          align: "left"
        }) // EPF No.
        .text(Employee.EMP_NO, 465.5, 97.169 + ypos, {
          width: 96.8,
          align: "left"
        }) // Employee No.
        .text(Employee.UAN_NUMBER, 139.5, 111.326 + ypos, {
          width: 241,
          align: "left"
        }) // UAN nO.
        .text(Employee.DEPT, 465.5, 111.326 + ypos, {
          width: 96.8,
          align: "left"
        }) // Department
        .text(Employee.PAY_BASIC.toString(), 194, 129.409 + ypos, {
          width: 52,
          align: "right"
        }) // Basic
        .text(Employee.PAY_HRA.toString(), 194, 141.659 + ypos, {
          width: 52,
          align: "right"
        }) // H.R.A.
        .text(Employee.PAY_CON.toString(), 194, 153.426 + ypos, {
          width: 52,
          align: "right"
        }) // Conveyance Allowance
        .text(Employee.PAY_EDU.toString(), 194, 165.583 + ypos, {
          width: 52,
          align: "right"
        }) // Education Allowance
        .text(Employee.PAY_BONUS.toString(), 194, 178.131 + ypos, {
          width: 52,
          align: "right"
        }) // Bonus
        .text(Employee.PAY_LEAVE.toString(), 194, 190.289 + ypos, {
          width: 52,
          align: "right"
        }) // Leave
        .text(Employee.PERF_ALW.toString(), 194, 201.953 + ypos, {
          width: 52,
          align: "right"
        }) // Performance Allowance
        .text(Employee.OTHER_ALW.toString(), 194, 214.409 + ypos, {
          width: 52,
          align: "right"
        }) // Other Allowance
        .text(Employee.PF.toString(), 520, 129.409 + ypos, {
          width: 52,
          align: "right"
        }) // Provident Fund
        .text(Employee.ESIC.toString(), 520, 141.659 + ypos, {
          width: 52,
          align: "right"
        }) // E.S.I.C.
        .text(Employee.PT.toString(), 520, 153.426 + ypos, {
          width: 52,
          align: "right"
        }) // Professional Tax
        .text(Employee.LWF.toString(), 520, 165.583 + ypos, {
          width: 52,
          align: "right"
        }) // L.W.F.
        .text(Employee.TDS.toString(), 520, 178.131 + ypos, {
          width: 52,
          align: "right"
        }) // T.D.S.
        .text(Employee.CASH_ADV.toString(), 520, 190.289 + ypos, {
          width: 52,
          align: "right"
        }) // Cash Advance
        .text(Employee.CHEQUE.toString(), 520, 201.953 + ypos, {
          width: 52,
          align: "right"
        }) // Cheque Advance
        .text(Employee.LOAN.toString(), 520, 214.409 + ypos, {
          width: 52,
          align: "right"
        }) // Loan
        .text(Employee.OTHER_DED.toString(), 520, 225.972 + ypos, {
          width: 52,
          align: "right"
        }); // Other Deductions
      doc
        .setFont("RobotoBold", "normal")
        .setFontSize(10)
        .text(Employee.TOTAL_EARNINGS.toString(), 194, 241.024 + ypos, {
          width: 52,
          align: "right"
        }) // Gross Salary
        .text(Employee.TOTAL_DED.toString(), 520, 241.024 + ypos, {
          width: 52,
          align: "right"
        }); // Total Deductions
      doc
        ...
        .setFontSize(16)
        .text("₹ " + Employee.NET_PAYMENT.toString(), 262, 235.609 + ypos, {
          width: 86,
          align: "center"
        }); // Net Salary
